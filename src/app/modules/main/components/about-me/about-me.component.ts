...
export class AboutMeComponent {
  ...
  constructor() { }
  public technicalSkills = ['Angular', 'React', 'Vue', 'Cypress', 'Jest', 'Git', 'Node js', 'Express', 'AWS', 'Mongo db', 'Redux', 'Rxjs', 'Html/css', 'Responsive design', "SKILLS.ITEM2.HERRAMIENTA1"]
